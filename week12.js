...
const makeThree = () => {
	...
	resultThree.textContent = multiply;
};
...
const makeEighteen = () => {
	...
	//Ваш код
	const result = str.replace(/world/ig, "JavaScript");
...
const makeTwentySeven = () => {
	//Ваш код
	const result = Math.round(Math.random() * 50) + 50;
